...
<body>
    ...
    <form method="POST" action="">
        <div style="text-align:center;"><?php $classObj->sobologin(); ?></div><br>
        <div style="text-align:center;" id="showmessage"></div>
        <div id="main-other">
            <div id="sub-other">
                ...
                <div class="information-all">
                    ...
                    <div class="check-text">
                        <div class="agree">
                            <p><a href="forgot"> Forgot Passord?</a></span></p>
                        </div>
            ...
            <div class="regnow">
                <input type="submit" name='sobo' value="Login">
            </div><br>
        </div>
        <p style="text-align: center;"><a href="signup">Not Registered?</a></p>
    ...
    <script>
        $(document).ready(function() {
            $('#verifymailform').click(function(e) {
                e.preventDefault();
                //alert('verify form clicked');
                var email = $("#mail").val();
                var username = $("#usname").val();
                var who = $("#cusid").val();
                //console.log(email,username,who);
                //console.log(earned)
                $.post('apis/resendverify.php', {
                    email: email,
                    user: username,
                    who: who,
                }, function(response) {
                    ...
                    if (response == 'sent') {
                        $("#showmessage").html('Email Verification link Resent');
                    } else {
                        $("#showmessage").html('Email Verification Link not sent');
                    }
                });
