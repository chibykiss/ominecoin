...
<head>
    ...
    <title>  Damac Trade  || User Dashboard || silver <?php $classObj->un(); ?> </title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Silver Investment</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                       <ul class="list-group">
                                            <li class="list-group-item text-center"><h4>$15000 - $49999</h4></li>
                                            <li class="list-group-item text-center"> <span class="ti ti-check"></span>  Commission -  15%  </li>
                                        ...
                                        <form class="form-horizontal" id="invest">
                                            ...
                                            <div class="input-group">
                                                 <span class="input-group-addon">$</span>
                                                     ...
                                                     <input type="hidden" id="plan" value="master">   
                                                     <input  type="number" id="amount"  min="15000" max="49999" class="form-control"  placeholder="Enter Amount" required />
                                            </div>   
