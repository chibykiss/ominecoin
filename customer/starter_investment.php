...
<head>
    ...
    <title>  Crypstaccel Tradefast   ||  User Dashboard || New Investment </title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Starter Investment</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <ul class="list-group">
                                            <li class="list-group-item text-center"><h4>$200 - $14999</h4></li>
                                            <li class="list-group-item text-center"> <span class="ti ti-check"></span>  Commission - 7%  </li>
                                        ...
                                        <form class="form-horizontal" id="invest">
                                            ...
                                            <div class="input-group">
                                                 <span class="input-group-addon">$</span>
                                                     ...
                                                     <input  type="number" id="amount"  min="200" max="14999" class="form-control"  placeholder="Enter Amount" required />
                                            </div>   
