...
<head>
    ...
    <title>Grandfx International  || Admin Dashboard || add admin </title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-header">
                                        <h4 class="text-center"> Creat new admin </h4>
                                        <p class="text-center"> <?php echo $_SESSION["admin_name"]; ?></p>
                                    </div>
                                    <div class="panel-body">
                                        <form id="invest" method="post">
                                          <input type="text" class="form-control" id="email" placeholder="admin id" required="yes" />
                                          <input type="password" class="form-control" id="pwd" placeholder="admin password" required ="yes" />
                                    </div>
                        ...
                        <div class="col-lg-12">
                                <div class="card">
                                    <div class="panel panel-primary">
                                        <div class="panel-header">
                                            <h4 class="text-center"> Active admins </h4>
           ...
           $('#invest').submit(function(e){
                ...
                // alert(who);
                   ...
                   /// $("#sun").html('<img src="../images/ajax-loader.gif" width="50" heigth="50" />');
                    ...
                    $.get("makepass.php?email="+email+"&pwd="+pwd, function(data){
                     
                     if (data == 'bad') {
                        swal("Error!", " This user exist already .", "error");
                     }else{
