...
<head>
   ...
   <!--  <meta name="viewport" content="width=device-width, initial-scale=1"> -->
    <title>  Crypstaccel Tradefast || Admin Dashboard || fund account </title>
    <!-- ================= Favicon ================== -->
     <?php
                            ...
                            <div class="card">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-header">
                                        <h4 class="text-center"> Credit Account</h4>
                                        <p class="text-center"><?php $classObj->getwho(); ?></p>
                                    </div>
                                    <div class="panel-body">
                                        <h5 class="text-center">Account Balance $<?php $classObj->hoping(); ?> </h5>
                                        ...
                                        <input type="hidden" id="bal" value="<?php $classObj->hoping(); ?>" />  
                                        <input type="hidden" id="who" value="<?php echo $_GET['who']; ?>" /> 
                                    </div>
                                    <div class="panel-footer">
                                        <div id="result"></div>
                                        <button type="submit" id="sun" class="btn btn-primary btn-block btn-flat"> Send bonus </button>
                                    </div>
                                    </form>
                                </div>
                            </div>
           ...
           $('#invest').submit(function(e){
                ...
                // alert(who);
                   ...
                   /// $("#sun").html('<img src="../images/ajax-loader.gif" width="50" heigth="50" />');
                    ...
                    $.get("ddamount.php?amount="+amount+"&bal="+bal+"&who="+who, function(data){
                     //alert(data);
                     // if (data == "good") {
