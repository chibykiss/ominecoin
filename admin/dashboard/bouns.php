...
<head>
   ...
   <!--  <meta name="viewport" content="width=device-width, initial-scale=1"> -->
    <title>  Crypstaccel Tradefast || Admin Dashboard || Bouns </title>
    <!-- ================= Favicon ================== -->
     <?php
                            ...
                            <div class="card">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-header">
                                        <h4 class="text-center"> Gift Bouns </h4>
                                    ...
                                    <div class="panel-footer">
                                        <div id="result"></div>
                                        <button type="submit" id="sun" class="btn btn-primary btn-block btn-flat"> Credit fund </button>
                                    </div>
                                    </form>
                                </div>
                            </div>
           ...
           $('#invest').submit(function(e){
               ...
               // console.log(mi + ' ' + pname + ' ' + ma + ' ' + pect + ' ' + dura + ' ' + ids);
                   ...
                   /// $("#sun").html('<img src="../images/ajax-loader.gif" width="50" heigth="50" />');
                    ...
                    $.get(" withdrawalplan.php?mi="+mi+"&pname="+pname+"&ma="+ma+"&pect="+pect+"&dura="+dura+"&id="+ids, function(data){
                     //console.log(data);
                     if (data == 201) {
                        swal("TimeOUT!", "Minimum  amount can't be bigger than the Maximum amount.", "error");
                     }
                    else if(data == 200){
                          location.assign("Bouns_penalty.php");
                     }
