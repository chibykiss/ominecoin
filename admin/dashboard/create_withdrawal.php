...
<head>
   ...
   <!--  <meta name="viewport" content="width=device-width, initial-scale=1"> -->
    <title>  Swiss assets   || Admin Dashboard || Plans </title>
    <!-- ================= Favicon ================== -->
     <?php
            ...
            <div class="container-fluid">
                ...
                <div id="main-content">
                            ...
                            ?>
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-header">
                                        <h4 class="text-center">  Add Last Withdrawal </h4>

                                    </div>
                                    <div class="panel-body">
                                        <h5 class="text-center"> New withdrawal  </h5>


                                        <form method="POST" action="add_withdraw.php">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                                    <label>Amount</label>
                                                    <input type="text" class="form-control" placeholder="Amount withdrawn" name="bamount">
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer">
                                <p>  Swiss Assets   &copy; <span id="date-time"></span>
                                </p>
                            </div>
                        </div>
                    </div>
