...
<head>
    ...
    <title>  Swiss Assets   || Admin Dashboard || Users </title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
            ...
            <div class="container-fluid">
                ...
                <div id="main-content">
                    <div class="row">
                             ...
                             <div class="col-lg-12">
                                <div class="card">
                                <a href="create_deposit.php" class="btn btn-primary"><i class="fa fa-plus-circle"></i> &nbsp;Add New</a>
                            ...
                            ?>
                                    <div class="panel panel-primary">
                                        <div class="panel-header">
                                            <h4 class="text-center"> Last Deposits</h4>
                                        </div>
